        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="animate-pulse">
              <div className="h-8 bg-neutral-300 rounded w-1/2 mx-auto mb-4"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="bg-white rounded-2xl shadow-lg">
                <div className="animate-pulse">
                  <div className="h-64 bg-neutral-300 rounded-t-2xl"></div>
                  <div className="p-6">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-lg text-neutral-600 max-w-3xl mx-auto mb-8">
              {error || "No featured destinations available at the moment."}
            </p>
            <Link
              href="/destinations"
