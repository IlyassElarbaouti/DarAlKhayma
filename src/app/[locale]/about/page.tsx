...
const values = [
	...
	},
	{
		...
		description:
			"We offer you the best destinations, urban and in the best locations, either to enjoy a vacation or to rest in a fully equipped stay when traveling for work, as we also offer corporate rentals for short or long stays.",
	},
];

// Fallback team data in case Sanity is not available
	...
	return (
		<PageWithHeaderPadding>
			...
			>
				...
				<div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
					<h1 className="font-display text-4xl md:text-6xl lg:text-7xl font-bold mb-6">
						About{" "}
						<span className="text-accent-400">Dar Al Khayma</span>
					</h1>
					<p className="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto leading-relaxed">
						Your gateway to authentic Moroccan hospitality and unforgettable
						experiences
					</p>
				</div>
			</motion.section>
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
						...
						>
							...
							<div className="space-y-6 text-lg text-neutral-600 leading-relaxed">
								<p>
									Founded with a passion for sharing Morocco's rich cultural
									heritage, Dar Al Khayma began as a vision to create authentic,
									luxury accommodations that honor traditional Moroccan hospitality
										while meeting modern comfort standards.
								</p>
								<p>
									Our name, which means "The Tent" in Arabic, reflects our
									commitment to providing a home away from home – a place where
									travelers can experience the warmth and generosity that Morocco is
									famous for.
								</p>
								<p>
									Today, we curate a collection of exceptional properties across
									Morocco's most beautiful destinations, each carefully selected and
									thoughtfully designed to offer guests an unforgettable journey into
									Moroccan culture and luxury.
								</p>
							</div>
						</motion.div>
						<motion.div
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					>
						...
						<p className="text-xl text-neutral-600 max-w-3xl mx-auto">
							These principles guide everything we do, from property selection to
							guest experience
						</p>
					</motion.div>
			...
			<motion.section
				...
				transition={{ duration: 0.6 }}
				viewport={{ once: true }}
				className="py-20 lg:py-32 bg-gradient-to-br from-primary-900 to-primary-800 text-white"
			>
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center max-w-4xl mx-auto">
						...
						<p className="text-xl md:text-2xl text-white/90 leading-relaxed mb-8">
							To provide travelers with authentic, luxury accommodations that
							celebrate Morocco's rich heritage while delivering exceptional modern
